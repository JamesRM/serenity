...
#define END_OF_PHYSICAL_RAM 0x3EFFFFFF
#define START_OF_MMIO       0x3F000000
#define END_OF_MMIO         0x3FFFFFFF
...
void activate_page_table();
void build_prekernel_page_tables();
